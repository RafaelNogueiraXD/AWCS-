...
<header>       <div class="cabes">
            ...
            <ul>
                ...
                <li><h3><a href=""><b>Produtos</b></a></h3></li>
                                ...
                                <?php
                                    ...
                                    foreach ($array as  $registro) {
                                      //  foreach ($registro as $key => $value) {
                                            ...
                                            <td><?= $registro['nome']?></td>
                                            <td><?= $registro['Tipo']?></td>
                                            <td><a href="1-prod.php?id=<?= $registro['id']?>">Visualizar</a></td>
                                            </tr>
                                           <?php
                                     //   }
                                    }
  ...
  ?>                                      
                     ...
                     <a class="btn btn-outline-secondary" href="../cd2/produto.php" role="button">Cadastre um Produto</a>
  <?php
                                    }
  ?>
            </center>
